                ...
                <div className="flex flex-col gap-8">
                  ...
                  <div className="text-gray-800 text-base sm:text-lg md:text-xl leading-relaxed text-left w-full">
                    ...
                    <p className="text-base sm:text-lg md:text-xl leading-loose">
                      เว็บไซต์การให้บริการวิเคราะห์และตรวจจับข่าวเท็จ ใช้สำหรับตรวจสอบว่า “ข่าวจริงหรือข่าวปลอม” จากข้อความข่าวและลิงก์เว็บไซต์ข่าว พร้อมให้เหตุผลประกอบ และโชว์แหล่งข่าวที่ใกล้เคียง<br />
                      • ใช้ Machine Learning (Logistic Regression) + LLM วิเคราะห์เหตุผล<br />
                      • มีระบบดึงหัวข้อข่าวจากเว็บด้วย Web Scraping และค้นหาแหล่งข่าวใกล้เคียงผ่าน serper.dev<br />
                      • พัฒนาเว็บไซต์ด้วย React + FastAPI<br />
                      • ออกแบบเว็บไซต์ด้วย Figma + Photoshop<br />
                      • ใช้ WangchanBERTa แปลงข้อความเป็นเวกเตอร์ และจัดเก็บข้อมูลด้วย Firebase / Database<br />
                      • มีหน้าผู้ใช้และหน้า Admin สำหรับจัดการโมเดล–ข้อมูลข่าวอย่างเป็นระบบ
                    </p>
                  </div>
                </div>
                {/* ========= BOX 2 ========= */}
